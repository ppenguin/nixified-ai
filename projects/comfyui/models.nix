## Taken straight out of https://raw.githubusercontent.com/LoganBarnett/dotfiles/eed1ad6c03283967320fb8bc04ed7b233b164f3b/nix/nixos-modules/comfyui-server.nix
...
let fetchModel = pkgs.callPackage ./fetch-model.nix {};
in {
  checkpoints = {
