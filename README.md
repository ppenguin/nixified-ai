...
If you want to quickly get up and running, you have the option of using the packages meant to serve the [Krita AI plugin](https://github.com/Acly/krita-ai-diffusion) (currently v1.19.0), but the flake also provides ways to customise your setup.
